    ...
    <div class="site-wrapper" id="container"><!-- Container for (Pushy) -->
      ...
      <!--[if IE]>
        <div class="alert alert-warning">
          <?php _e('You are using an <strong>outdated</strong> browser. Please <a href="http://browsehappy.com/">upgrade your browser</a> to improve your experience.', 'teruterubozu'); ?>
        </div>
      <![endif]-->
